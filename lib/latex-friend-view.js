...
require("lodash");
var TextEditorView = AtomSpacePenViews.TextEditorView;
...
var LatexFriendNavigationView = (function (_super) {
    ...
    LatexFriendNavigationView.content = function (params) {
        var _this = this;
        console.log('starting content [TS]');
...
var LatexFriendReferencesView = (function (_super) {
    __extends(LatexFriendReferencesView, _super);
    function LatexFriendReferencesView(references) {
        ...
        console.log("Starting view [TS]");
    }
    LatexFriendReferencesView.prototype.getFilterKey = function () {
        return 'name';
    };
    LatexFriendReferencesView.prototype.viewForItem = function (item) {
        return "<li class='level#{item.level}'>" + item.name + "</li>";
    };
    LatexFriendReferencesView.prototype.confirmed = function (item) {
    ...
    LatexFriendReferencesView.prototype.cancel = function () {
        _super.prototype.cancel.call(this);
        console.log('Cancelling');
        this.panel.hide();
    };
    return LatexFriendReferencesView;
}(AtomSpacePenViews.SelectListView));
exports.LatexFriendReferencesView = LatexFriendReferencesView;
        ...
        this.div({ class: 'navigation block' }, function () {
            _this.div(function () {
                _this.div({ class: 'smallInput inline-block' }, function () {
                    _this.label('Rows');
                    _this.subview('rows', new TextEditorView({ mini: true }));
                });
                _this.div({ class: 'smallInput inline-block' }, function () {
                    _this.label('Columns');
                    _this.subview('columns', new TextEditorView({ mini: true }));
                });
            });
            _this.div(function () {
